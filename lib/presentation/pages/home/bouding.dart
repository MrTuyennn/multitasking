            ...
            child: Padding(
              ...
              child: GestureDetector(
                ...
                onScaleStart: (details) {
                  ...
                  String? corner;
                  if ((details.localFocalPoint - tl).distance <= cornerHit)
                    corner = 'tl';
                  else if ((details.localFocalPoint - tr).distance <= cornerHit)
                    corner = 'tr';
                  else if ((details.localFocalPoint - bl).distance <= cornerHit)
                    corner = 'bl';
                  else if ((details.localFocalPoint - br).distance <= cornerHit)
                    corner = 'br';
                ...
                onScaleUpdate: (details) {
                  ...
                  setState(() {
                    ...
                    if (_activeCorner != null) {
                      ...
                      double maxKY;
                      if (signX > 0) {
                        maxKX = (workRight - pad - anchor.dx) / baseWidth;
                      } else {
                        maxKX = (anchor.dx - pad) / baseWidth;
                      }
                      if (signY > 0) {
                        maxKY = (workBottom - pad - anchor.dy) / baseHeight;
                      } else {
                    ...
                    if (_activeCorner != null) {
                      ...
                      nextOffset =
                          _initialOffset + (details.localFocalPoint - _initialFocal);
                    }
                  ...
                  final maxCenterX = workAreaWidth - newWidth / 2 - pad;
                  final minCenterY = newHeight / 2 + pad;
                  final maxCenterY = workAreaHeight - newHeight / 2 - pad;
